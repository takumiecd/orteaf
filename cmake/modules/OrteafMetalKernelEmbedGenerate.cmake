...
string(APPEND content "#include \"orteaf/internal/runtime/mps/platform/wrapper/metal_kernel_embed_api.h\"\n")
string(APPEND content "#include <array>\n\n")
string(APPEND content "namespace orteaf::internal::runtime::mps::platform::metal_kernel_embed {\n\n")

...
foreach(record ${record_list})
    ...
    if(fmt STREQUAL "fatbin")
        set(fmt_enum "KernelFmt::Fatbin")
    elseif(fmt STREQUAL "cubin")
        set(fmt_enum "KernelFmt::Cubin")
    elseif(fmt STREQUAL "ptx")
        set(fmt_enum "KernelFmt::Ptx")
    else()
...
string(APPEND content "    KernelFmt fmt;\n")
...
string(APPEND content "static Blob find_exact(std::string_view name, KernelFmt fmt) {\n")
...
string(APPEND content "static Blob try_format(std::string_view name, KernelFmt fmt) {\n")
string(APPEND content "    switch (fmt) {\n")
string(APPEND content "    case KernelFmt::Fatbin:\n")
string(APPEND content "#if ORTEAF_EMBED_HAS_FATBIN\n")
string(APPEND content "        return find_exact(name, KernelFmt::Fatbin);\n")
string(APPEND content "#else\n")
string(APPEND content "        return {nullptr, 0};\n")
string(APPEND content "#endif\n")
string(APPEND content "    case KernelFmt::Cubin:\n")
string(APPEND content "#if ORTEAF_EMBED_HAS_CUBIN\n")
string(APPEND content "        return find_exact(name, KernelFmt::Cubin);\n")
string(APPEND content "#else\n")
string(APPEND content "        return {nullptr, 0};\n")
string(APPEND content "#endif\n")
string(APPEND content "    case KernelFmt::Ptx:\n")
string(APPEND content "#if ORTEAF_EMBED_HAS_PTX\n")
string(APPEND content "        return find_exact(name, KernelFmt::Ptx);\n")
string(APPEND content "#else\n")
string(APPEND content "        return {nullptr, 0};\n")
string(APPEND content "#endif\n")
string(APPEND content "    }\n")
...
string(APPEND content "Blob find_kernel_data(std::string_view name, KernelFmt prefer, Blob fallback) {\n")
...
string(APPEND content "    }\n")
string(APPEND content "    constexpr KernelFmt order[] = {KernelFmt::Fatbin, KernelFmt::Cubin, KernelFmt::Ptx};\n")
string(APPEND content "    for (KernelFmt fmt : order) {\n")
...
string(APPEND content "bool available(std::string_view name, KernelFmt fmt) {\n")
